...
import {
  Lock, LogOut, Shield, Key, Database, Eye, Users, Server, ArrowRight,
    ...
    <div className="min-h-screen bg-surface">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <section className="mb-12 rounded-xl border border-primary/20 bg-surface-container-low/50 p-6 sm:p-8">
          ...
          <div className="mb-8">
            ...
            <div className="overflow-x-auto pb-2">
              <div className="flex items-stretch gap-0 min-w-[720px]">
                ...
                <div className="flex items-center px-1 text-on-surface-variant/30"><ArrowRight className="w-4 h-4" /></div>
                <div className="flex-1 rounded-r-lg border border-domain-ml/30 bg-domain-ml/5 p-3 text-center">
                  <div className="font-mono text-[10px] text-domain-ml/60 mb-1">STORAGE</div>
                  <HardDrive className="w-5 h-5 text-domain-ml mx-auto mb-1" />
          ...
          <div className="mb-8">
            <h3 className="font-label text-xs font-semibold text-on-surface-variant/50 uppercase tracking-wider mb-4">Security Controls by Domain</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="rounded-lg border border-primary/20 bg-primary/5 p-4">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="ml-auto font-mono text-[10px] bg-domain-ml/10 text-domain-ml px-2 py-0.5 rounded-full">MITIGATED</span>
                </div>
                <ul className="space-y-1.5 font-body text-xs text-on-surface-variant/60">
                  <li className="flex items-start gap-2">
                    <CircleCheck className="w-3 h-3 text-domain-ml mt-0.5 flex-shrink-0" />
              ...
              {/* Storage Protection */}
              <div className="rounded-lg border border-domain-ml/20 bg-domain-ml/5 p-4">
                <div className="flex items-center gap-2 mb-3">
                  <HardDrive className="w-4 h-4 text-domain-ml" />
              ...
              <table className="w-full text-left">
                ...
                <tbody className="font-body text-xs">
                  <tr className="border-b border-outline-variant/10">
                    ...
                    <td className="py-2 pr-4"><span className="text-domain-ml">Mitigated</span></td>
