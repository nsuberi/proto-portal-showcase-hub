        ...
        >
          ...
          {run.status === "running" && (
            <button
              ...
              className="p-0.5 text-on-surface-variant/60 hover:text-error transition-colors"
              title="Stop run"
            >
          ...
          {run.status !== "running" && (
            <button
              ...
              className="p-0.5 text-on-surface-variant/60 hover:text-on-surface-variant/80 transition-colors"
              title="Close tab"
            >
