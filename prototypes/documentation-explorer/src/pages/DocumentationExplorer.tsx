  ...
  return (
    <div className="relative min-h-[calc(100vh-8rem)] overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto pt-20">
        <Card className="bg-white/10 dark:bg-black/10 backdrop-blur-xl shadow-2xl border border-white/20 dark:border-white/5 ring-1 ring-blue-200/20 dark:ring-blue-400/10">
